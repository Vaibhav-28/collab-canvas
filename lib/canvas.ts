...
// const cursorUrl = "/assets/cursor.svg";
...
export const initializeFabric = ({
  ...
  if (fabricRef.current) {
    // Dispose of the existing canvas to avoid the initialization error
  ...
  Array.from(canvasObjects, ([objectId, objectData]) => {
    ...
    fabric.util.enlivenObjects([objectData], {
      reviver: (
        ...
        instance: fabric.Object | any
      ) => {
        // Check if the instance is of type fabric.Object
        ...
        // If it's not a fabric.Object, you can log or handle it differently if necessary
      },
    });
  });
